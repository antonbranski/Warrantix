...
public class WalletBrandInsurance0 extends BaseActivity {
    ...
    public void InitializeView() {
        ...
        BackendManager.getInstance().getServiceCompaniesResponse(WarrantixPreference.TYPE_INSURANCE, WarrantixPreference.BRANDID_HEROID);
    ...
    public void onServiceCompaniesSuccessEvent(final ServiceCompaniesSuccessEvent event) {
        WalletBrandInsurance0.this.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                ...
                if (getServiceCompaniesResponse != null) {
                    ...
                    if (serviceCompanies.size() != 0) {
                        WalletBrandInsuranceList adapter = new WalletBrandInsuranceList(WalletBrandInsurance0.this, serviceCompanies);
