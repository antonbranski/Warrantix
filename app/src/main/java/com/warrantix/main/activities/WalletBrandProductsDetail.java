...
public class WalletBrandProductsDetail extends BaseActivity {
    ...
    private static int SCHEDULE_RESULT_CODE = 100;
...
//                maskView.setOnClickListener(maskViewClickListener);
        ...
        if (myProduct != null) {
            String imageURL = myProduct.getImageThmb();
        ...
        viewmanualTXT.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                WarrantixApplication.getInstance().openPDFFiles(WalletBrandProductsDetail.this, "manual.pdf");
            }
        });
        ...
        viewinvoiceTXT.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                WarrantixApplication.getInstance().openPDFFiles(WalletBrandProductsDetail.this, "invoice.pdf");
            }
        });
        ...
        entitlementTXT.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                WarrantixApplication.getInstance().openPDFFiles(WalletBrandProductsDetail.this, "entitlements.pdf");
            }
        });
        ...
        if (myProduct != null)
            nametxt.setText(myProduct.getName());
        ...
        skuText = (TextView) findViewById(R.id.txt_sku);
        if (myProduct != null)
            skuText.setText(myProduct.getSku() + " ");

        modeltxt = (TextView) findViewById(R.id.modelTXT);
        modelvaluetxt = (TextView) findViewById(R.id.modelvalueTXT);
        if (myProduct != null)
            modelvaluetxt.setText(myProduct.getModel());
        ...
        ScheduleServiceBTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (myProduct != null)
                    ...
                    startActivityForResult(mIntent, SCHEDULE_RESULT_CODE, true);
            }
        });
        ...
        dialBTN.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String contactNumber = BackendManager.getInstance().getContactFromProduct(myProduct);
                WarrantixApplication.getInstance().showDial(WalletBrandProductsDetail.this, contactNumber);
            }
        });
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        {
            if (requestCode == SCHEDULE_RESULT_CODE){
                finish();
            }
        }
        else {
