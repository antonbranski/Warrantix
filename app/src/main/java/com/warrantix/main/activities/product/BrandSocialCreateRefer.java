...
import com.warrantix.main.customview.RecipientScrollView;
...
public class BrandSocialCreateRefer extends BaseActivity {
    ...
    public void Initialize(){
        ...
        doneBTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                referMessageContent.setBrandID(WarrantixPreference.BRANDID_HEROID);
                referMessageContent.setProductID(tokens);
                referMessageContent.setCustomerID(recipients);
                referMessageContent.setType("refer");
                referMessageContent.setContent(content);

                BackendManager.getInstance().addRefer(referMessageContent);
        ...
        referviaTXT.setTokenListView(productListView, productAdapter, btnDrop1);
    ...
    @Subscribe
    public void onAddReferSuccessEvent(final AddReferSuccessEvent event)
    {
        BrandSocialCreateRefer.this.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                ReferAddResponse referAddResponse = event.getReferAddResponse();
