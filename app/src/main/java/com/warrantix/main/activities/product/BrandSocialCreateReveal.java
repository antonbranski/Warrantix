...
public class BrandSocialCreateReveal extends BaseActivity {
    ...
    public void Initialize(){
        ...
        doneBTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                revealMessageContent.setBrandID(WarrantixPreference.BRANDID_HEROID);
                revealMessageContent.setProductID(products);
                revealMessageContent.setCustomerID(recipients);
                revealMessageContent.setType("reveal");

                BackendManager.getInstance().addReveal(revealMessageContent);
    ...
    @Subscribe
    public void onAddRevealSuccessEvent(final AddRevealSuccessEvent event)
    {
        BrandSocialCreateReveal.this.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                RevealAddResponse revealAddResponse = event.getRevealAddResponse();
