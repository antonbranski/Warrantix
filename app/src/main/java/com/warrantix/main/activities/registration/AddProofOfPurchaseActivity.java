...
public class AddProofOfPurchaseActivity extends BaseActivity {
    ...
    private static final String TAG = AddProofOfPurchaseActivity.class.getSimpleName();
    ...
    private final PictureProcessingCallback pictureProcessingCallback = new PictureProcessingCallback() {
        ...
        public void onPictureTaken(byte[] bytes) {
            ...
            try {
                ...
                Log.d(TAG, "picture successfully compressed at:" + uri + compressed);
                outputStream.close();
            ...
            Log.d(TAG, "jpeg data length " + bytes.length);
