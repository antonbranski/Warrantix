...
public class ProofPurchaseActivity extends BaseActivity {
    private static final String TAG = ProofPurchaseActivity.class.getSimpleName();
...
//            startActivityForResult(Intent.createChooser(intent, "Select File"), SELECT_FILE);
    ...
    private final View.OnClickListener btnSkipClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            i.putExtra("brand", getIntent().getStringExtra("brand"));
            i.putExtra("model", getIntent().getStringExtra("model"));
...
//    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        Log.d(TAG, "OnActivityResult: ProofPurchaseActivity, requestCode = " + requestCode + " resultCode = " + resultCode);
