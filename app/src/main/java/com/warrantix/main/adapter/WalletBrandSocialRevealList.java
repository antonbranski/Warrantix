...
public class WalletBrandSocialRevealList extends BaseAdapter {
    ...
    public WalletBrandSocialRevealList(Activity context, List<Message> messages, List<Product> products, List<CustomerResponse> customerResponses) {
...
//        placeText.setText("owns a "+mProducts.get(position).getName());
        nameText.setText(mProducts.get(position).getName());
        placeText.setText(mCustomerResponses.get(position).getUsername());
