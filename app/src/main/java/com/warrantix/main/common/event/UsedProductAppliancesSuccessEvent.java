...
public class UsedProductAppliancesSuccessEvent
{
    private GetUsedProductsResponse mGetUsedProductResponse = new GetUsedProductsResponse();
    private List<Product> mProducts = new ArrayList<>();

    public UsedProductAppliancesSuccessEvent(GetUsedProductsResponse getUsedProductsResponse, List<Product> products)
    {
