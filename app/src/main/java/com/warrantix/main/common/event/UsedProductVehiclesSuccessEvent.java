...
public class UsedProductVehiclesSuccessEvent
{
    private GetUsedProductsResponse mGetUsedProductResponse = new GetUsedProductsResponse();
    private List<Product> mProducts = new ArrayList<>();

    public UsedProductVehiclesSuccessEvent(GetUsedProductsResponse getUsedProductsResponse, List<Product> products)
    {
