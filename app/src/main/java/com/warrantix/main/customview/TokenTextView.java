...
public class TokenTextView extends AppCompatEditText implements TokenListAdapter.OnTokenItemSelectListener /*, View.OnTouchListener */ {
	...
	private OnTokenUpdatedListener updatedListener = null;
	private ImageButton dropImageButton = null;
...
//		setOnTouchListener(this);
	...
	public void setTokenListView(ListView listView, TokenListAdapter adapter, ImageButton dropImageButton) {
		this.relatedListView = listView;
		this.relatedListAdapter = adapter;
		this.dropImageButton = dropImageButton;
	...
	public void setTokenUpdatedListener(OnTokenUpdatedListener listener) {
...
//		setText(currentText);
		...
		dropImageButton.setBackgroundResource(R.drawable.check);
		relatedListView.setVisibility(GONE);

		//
		// not determined yet
		//
//		if (relatedListView != null)
//			relatedListView.setVisibility(View.GONE);

		if (updatedListener != null)
			updatedListener.onTokenUpdated(token);
	}
