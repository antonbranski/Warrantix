...
public class WalletBrandInsuranceFragment1 extends BaseFragment implements View.OnClickListener {
    ...
    public void InitializeView() {
        ...
        termsTxt = (TextView) mView.findViewById(R.id.termsTxt);
        ...
        selectView.setBackgroundResource(!((WalletBrandInsurance)getActivity()).isAcceptedSelect ? R.drawable.square : R.drawable.square_tick);

        selectView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ((WalletBrandInsurance)getActivity()).isAcceptedSelect = !((WalletBrandInsurance)getActivity()).isAcceptedSelect;
                selectView.setBackgroundResource(!((WalletBrandInsurance)getActivity()).isAcceptedSelect ? R.drawable.square : R.drawable.square_tick);
            }
        });
        ...
        this.duration.setTokenListView(durationView, durationAdapter, btnDrop4);
    }

    @Override
    public void onClick(View v) {
        if (v.getId() == R.id.nextBTN) {
            if (((WalletBrandInsurance)getActivity()).isAcceptedSelect == false) {
        ...
        } else if (v.getId() == R.id.termsTxt) {
            WarrantixApplication.getInstance().openPDFFiles(getActivity(), "terms.pdf");
        }
