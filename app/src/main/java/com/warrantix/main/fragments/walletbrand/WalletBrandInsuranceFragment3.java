...
public class WalletBrandInsuranceFragment3 extends BaseFragment implements View.OnClickListener {
    ...
    public void InitializeView() {
        ...
        doneBTN.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (((WalletBrandInsurance)getActivity()).isAccepted3Select == false) {
...
//                    if (WarrantixPreference.loadBooleanPreference(Constant.isFromPlugin))
        ...
        selectView.setBackgroundResource(!((WalletBrandInsurance)getActivity()).isAccepted3Select ? R.drawable.square : R.drawable.square_tick);
        selectView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (((WalletBrandInsurance)getActivity()).isAccepted3Select == false)
                    ((WalletBrandInsurance)getActivity()).isAccepted3Select = true;
                else
                    ((WalletBrandInsurance)getActivity()).isAccepted3Select = false;
