        ...
        getActivity().runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if (getProductResponse != null){
                    List<Customer> customersByRate = event.getCustomersByRate();
                    if (customersByRate != null) {
                        WalletBrandSocialRankList adapter = new WalletBrandSocialRankList(getActivity(),getProductResponse.getProduct(), customersByRate);
                        list.setAdapter(adapter);
                    }
                }
            }
