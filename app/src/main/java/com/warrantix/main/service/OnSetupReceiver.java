...
//
                ...
                startIntent.setComponent(new ComponentName("com.warrantix.hero", "com.warrantix.hero.RegisterActivity"));
                startIntent.addFlags(Intent.FLAG_ACTIVITY_NO_HISTORY | Intent.FLAG_ACTIVITY_CLEAR_WHEN_TASK_RESET | Intent.FLAG_ACTIVITY_MULTIPLE_TASK | Intent.FLAG_ACTIVITY_NEW_TASK);
